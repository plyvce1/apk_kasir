            ...
            <form action="/pelanggan/update/<?= $pelanggan['PelangganID']; ?>" method="post">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control<?php if (session('errors.namaPelanggan')) : ?>is-invalid <?php endif ?>" id="namaPelanggan" name="namaPelanggan" value="<?= $pelanggan['nama_pelanggan'] ?>" placeholder="Masukan Nama Pelanggan" required autofocus>
                    <div class="ms-2">
