      ...
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header pb-0">
            <h6><i class="ni ni-box-2 text-dark align-items-center" aria-hidden="true"></i>&nbsp;Tambah Pelanggan</h6>
            ...
            <form action="<?= base_url() ?>/pelanggan/save" method="post">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control <?= ($validation->hasError('nama_pelanggan')) ? 'is-invalid' : ''; ?>" id="namaPelanggan" name="namaPelanggan" autofocus value="<?= old('namaPelanggan') ?>" placeholder="Masukan Nama Pelanggan">
                </div>
                <div class="form-group">
                  <label>Alamat</label>
                  <input type="text" class="form-control <?= ($validation->hasError('alamat')) ? 'is-invalid' : ''; ?>" id="Alamat" name="Alamat" autofocus value="<?= old('') ?>" placeholder="Masukkan Alamat" autocomplete="off">
                </div>
                <div class="form-group">
                  <label>Nomor Telepon</label>
                  <input type="number" class="form-control <?= ($validation->hasError('nomor_telepon')) ? 'is-invalid' : ''; ?>" id="nomorTelepon" name="nomorTelepon" autofocus value="<?= old('') ?>" placeholder="Masukkan Nomor Telepon" autocomplete="off">
                </div>
                <!-- /.card-body -->
                <div class="mb-0 mt-4">
