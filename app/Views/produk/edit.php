            ...
            <form action="/produk/update/<?= $produk['ProdukID']; ?>" method="post">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control <?php if (session('errors.namaProduk')) : ?>is-invalid<?php endif?>" id="namaProduk" name="namaProduk" autofocus value="<?= $produk['nama_produk'] ?>" placeholder="Masukan Nama Produk" required autofocus>
                <div class="ms-2">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control <?php if (session('errors.hargaBeli')) : ?>is-invalid<?php endif?>" id="hargaBeli" name="hargaBeli" autofocus value="<?= $produk['harga_beli'] ?>">
                    <div class="ms-2">
                  <?php if(session()->has('errors')) : ?>
                    <?php foreach(session('errors')as $field => $error) :?>
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control   <?php if (session('errors.hargaJual')) : ?>is-invalid<?php endif?>" id="hargaJual" name="hargaJual" autofocus value="<?= $produk['harga_jual'] ?>">
                    <div class="ms-2">
                  <?php if(session()->has('errors')) : ?>
                    <?php foreach(session('errors')as $field => $error) :?>
                ...
                <div class="form-group">
                  <label>Stock</label>
                  <input type="text" class="form-control <?php if (session('errors.stok')) : ?>is-invalid<?php endif?>" id="stok" name="stok" autofocus value="<?= $produk['stock'] ?>">
                    <!-- card-body -->
                    <div class="ms-2">
                  <?php if(session()->has('errors')) : ?>
                    <?php foreach(session('errors')as $field => $error) :?>
