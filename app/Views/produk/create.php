            ...
            <form action="<?= base_url() ?>/produk/save" method="post">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control uang <?php if (session('errors.hargaBeli')) : ?>is-invalid<?php endif ?>" id="hargaBeli" name="hargaBeli" autofocus value="<?= old('') ?>" placeholder="Masukkan Harga Beli" autocomplete="off">
                  <div class="ms-2">
                    <?php if (session()->has('errors')) : ?>
                      <?PHP foreach (session('errors') as $field => $error) : ?>
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control uang <?php if (session('errors.hargaJual')) : ?>is-invalid<?php endif ?>" id="hargaJual" name="hargaJual" autofocus value="<?= old('') ?>" placeholder="Masukkan Harga Jual" autocomplete="off">
                  <div class="ms-2">
                    <?php if (session()->has('errors')) : ?>
                      <?PHP foreach (session('errors') as $field => $error) : ?>
                ...
                <div class="form-group">
                  <label>Stock</label>
                  <input type="text" class="form-control <?php if (session('errors.stok')) : ?>is-invalid<?php endif ?>" id="stok" name="stok" autofocus value="<?= old('') ?>" placeholder="Masukkan Stock" autocomplete="off">
                  <div class="ms-2">
                    <?php if (session()->has('errors')) : ?>
                      <?PHP foreach (session('errors') as $field => $error) : ?>
                        <?php if ($field === 'hargaJual') : ?>
